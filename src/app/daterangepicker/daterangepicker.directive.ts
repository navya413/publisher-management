...
export class DaterangepickerDirective implements OnInit, OnChanges, DoCheck {
  ...
  @Output('rangeClicked')
  rangeClicked: EventEmitter<Object> = new EventEmitter();
  @Output('datesUpdated')
  datesUpdated: EventEmitter<Object> = new EventEmitter();
